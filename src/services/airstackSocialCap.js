...
export const fetchSocialCapitalData = async () => {
  ...
  if (response.errors) {
    console.error("Airstack Social Capital API Error:", response.errors); // Log any errors from the response
  } else {
    console.log("Airstack Social Capital API Response:", response); // Log the response data
  }
